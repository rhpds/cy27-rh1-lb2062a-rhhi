...
**Owner:** nzwulfin
**Migrated from:** https://github.com/rhel-labs/zt-hardened-images
...
1. Open in DevSpaces: `https://devspaces.apps.ocpv-infra02.wdc07.infra.demo.redhat.com#https://github.com/rhpds/cy27-rh1-lb2062a-rhhi`
...
2. Clone the repo:
   ```
   git clone https://github.com/rhpds/cy27-rh1-lb2062a-rhhi
   ```
3. `cd cy27-rh1-lb2062a-rhhi`
